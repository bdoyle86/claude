...
CREATE TABLE IF NOT EXISTS teams (
  ...
  card_1_id INTEGER REFERENCES cards(id),
  card_2_id INTEGER REFERENCES cards(id),
  card_3_id INTEGER REFERENCES cards(id),
  card_4_id INTEGER REFERENCES cards(id),
  card_5_id INTEGER REFERENCES cards(id),
