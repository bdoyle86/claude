      ...
      <div className="relative z-10 flex w-full grow flex-col justify-between p-6">
        ...
        <main className="flex flex-col items-center justify-center grow py-8">
          <div className="w-full max-w-sm space-y-8">
            <div className="text-center">
              <h1 className="font-pixel text-3xl leading-tight text-white" style={{ textShadow: '2px 2px 0px #000' }}>The Pitch Awaits</h1>
              <p className="mt-2 text-2xl text-bright-cyan">Log in to build your squad!</p>
            </div>
        ...
        <footer className="flex w-full items-center justify-center py-4">
          <p className="text-center text-xl font-normal leading-normal text-white">
            ...
            <Link to="/register" className="font-bold text-bright-yellow underline hover:text-bright-cyan">SIGN UP!</Link>
          </p>
        </footer>
      </div>
    </div>
